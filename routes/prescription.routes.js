...
import { createPrescriptionSchema, aiExplanationSchema } from "../validation/prescription.validation.js";
import { createPrescription, getPrescriptionById, getPatientPrescriptions, getDoctorPrescriptions, generatePDF, generateAIExplanation } from "../controllers/prescription.controller.js";
...
router.post("/ai/explain", requireProPlan, validate(aiExplanationSchema), generateAIExplanation);
