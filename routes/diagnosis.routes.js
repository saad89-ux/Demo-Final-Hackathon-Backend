...
import { symptomCheckerSchema, saveDiagnosisSchema, ratingSchema } from "../validation/diagnosis.validation.js";
import { runAISymptomCheck, saveFinalDiagnosis, runRiskFlagging, getDiagnosisHistory, rateDoctor, getDoctorDashboard } from "../controllers/diagnosis.controller.js";

const router = express.Router();

router.use(verifyToken);

router.post("/ai/symptom-check", verifyDoctor, requireProPlan, aiLimiter, validate(symptomCheckerSchema), runAISymptomCheck);
